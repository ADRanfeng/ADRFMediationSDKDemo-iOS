...
@interface ADRFMediationRingProgressView ()

@property (nonatomic, strong) UILabel *percentage;

@end

@implementation ADRFMediationRingProgressView
...
// 状态栏高度  此处未作是否刘海屏幕判断
#define kADRFStatusBarHeight 44
    CGFloat y = kADRFStatusBarHeight + kSkipViewTopMargin;
