//
//  AdRFMediationInterstitialViewController.m
...
@interface AdRFMediationInterstitialViewController ()<ADRFMediationSDKIntertitialAdDelegate>

@property (nonatomic, strong) ADRFMediationSDKIntertitialAd *intertitialAd;
@property(nonatomic ,assign) BOOL isReady;

@end

@implementation AdRFMediationInterstitialViewController
